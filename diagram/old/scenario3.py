...
# add a legend
plt.legend(bbox_to_anchor=(0.5, -0.27), loc='lower center', ncol=5, frameon=False)

# add axis labels and a title
plt.xlabel("Charging position", fontweight='bold')
plt.ylabel("Total path length (unit)", fontweight='bold')
plt.title("Scenario 3 - Influence of charging position", fontweight='bold')

# show the plot
plt.tight_layout()
plt.savefig('draw/img/scenario3.png')
plt.show()
