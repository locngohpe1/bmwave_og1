    ...
    def draw_return_arrow(self, return_matrix):
        ...
        while queue:
            ...
            if prev_depth != cur_depth:
                ...
                pg.display.flip()
                pg.image.save(self.WIN, 'tmp/screenshot.png')
                time.sleep(0.5)
                input()
            ...
            for dx, dy in neighbors:
                ...
                pg.draw.line(self.WIN, GREY, self.index2coordinate((x, y)), self.index2coordinate(return_matrix[(x, y)][0]), width=2)
